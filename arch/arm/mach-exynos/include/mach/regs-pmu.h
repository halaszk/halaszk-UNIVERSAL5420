...
#define S5P_MIPI_DPHY_CONTROL(n)		((soc_is_exynos5250() || soc_is_exynos5260() || soc_is_exynos4415())? \
...
#define EXYNOS5260_USE_PROLONGED_LOGIC_RESET		(1 << 12)
...
#define EXYNOS5260_LPI_MASK_ISP_BUSMASTER_ALL		(0x3F)
