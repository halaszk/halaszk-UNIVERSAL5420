...
static struct sleep_gpio_tables mega2elte_sleep_gpio_tables[MAX_BOARD_REV];
static int nr_mega2elte_sleep_gpio_table;

static struct gpio_init_data __initdata init_gpio_table[] = {
	{ EXYNOS5260_GPA1(2), S3C_GPIO_OUTPUT, GPIO_LV_L, S3C_GPIO_PULL_DOWN }, /* PROX_LED_EN */
	...
	{ EXYNOS5260_GPB3(2), S3C_GPIO_INPUT, GPIO_LV_H, S3C_GPIO_PULL_NONE }, /* LCD_I2C_SDA_1.8V */
	{ EXYNOS5260_GPB3(3), S3C_GPIO_INPUT, GPIO_LV_H, S3C_GPIO_PULL_NONE }, /* LCD_I2C_SCL_1.8V */
	...
	{ EXYNOS5260_GPB4(6), S3C_GPIO_OUTPUT, GPIO_LV_L, S3C_GPIO_PULL_NONE }, /* IRDA_EN */
	{ EXYNOS5260_GPB4(7), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* e_FUSE_ON */
	...
	{ EXYNOS5260_GPC4(2), S3C_GPIO_OUTPUT, GPIO_LV_H, S3C_GPIO_PULL_NONE }, /* LCD_ON */
	...
	{ EXYNOS5260_GPD1(1), S3C_GPIO_OUTPUT, GPIO_LV_H, S3C_GPIO_PULL_NONE }, /* PANEL_ENP */
	{ EXYNOS5260_GPD1(2), S3C_GPIO_OUTPUT, GPIO_LV_H, S3C_GPIO_PULL_NONE }, /* PANEL_ENN */
	...
	{ EXYNOS5260_GPF1(7), S3C_GPIO_INPUT, GPIO_LV_N, S3C_GPIO_PULL_NONE }, /* ERR_FG */
	...
	{ EXYNOS5260_GPX2(4), S3C_GPIO_SFN(0xF), GPIO_LV_H, S3C_GPIO_PULL_UP }, /* T_FLASH_DETECT */
...
static struct gpio_sleep_data sleep_gpio_table_default[] = {
	...
	{ EXYNOS5260_GPB4(6), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE }, /* IRDA_EN */
	{ EXYNOS5260_GPB4(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE }, /* e_FUSE_ON */
	...
	{ EXYNOS5260_GPB5(6), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE }, /* S_LED_I2C_SDA */
	{ EXYNOS5260_GPB5(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_UPDOWN_DISABLE }, /* S_LED_I2C_SCL */

	{ EXYNOS5260_GPC4(2), S5P_GPIO_PD_OUTPUT1, S5P_GPIO_PD_UPDOWN_DISABLE }, /* LCD_ON */
	...
	{ EXYNOS5260_GPD1(0), S5P_GPIO_PD_OUTPUT0, S5P_GPIO_PD_UPDOWN_DISABLE }, /* CAM_SENSOR_A2.8V_VT_EN */

	{ EXYNOS5260_GPD1(1), S5P_GPIO_PD_OUTPUT1, S5P_GPIO_PD_UPDOWN_DISABLE }, /* LCD_ENP */
	{ EXYNOS5260_GPD1(2), S5P_GPIO_PD_OUTPUT1, S5P_GPIO_PD_UPDOWN_DISABLE }, /* LCD_ENN */
	...
	{ EXYNOS5260_GPE0(7), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },   /* TP4016 */

	{ EXYNOS5260_GPE1(0), S5P_GPIO_PD_PREV_STATE, S5P_GPIO_PD_UPDOWN_DISABLE },/* IPC_SLAVE_WAKEUP */
	{ EXYNOS5260_GPE1(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* TP4017 */
	...
	{ EXYNOS5260_GPC4(0), S5P_GPIO_PD_OUTPUT0, S5P_GPIO_PD_DOWN_ENABLE },	/* PEN_RESET_N_1.8V */
	{ EXYNOS5260_GPC4(1), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE },	/* PEN_PDCT_1.8V */
	{ EXYNOS5260_GPC4(3), S5P_GPIO_PD_INPUT, S5P_GPIO_PD_DOWN_ENABLE }, /* 2_TOUCH_ID */
...
static void config_sleep_gpio_tables(void)
{
	...
	for (i = nr_mega2elte_sleep_gpio_table - 1; i >= 0; i--)
		config_sleep_gpio(mega2elte_sleep_gpio_tables[i].table,
				mega2elte_sleep_gpio_tables[i].arr_size);
}

void __init board_mega2elte_gpio_init(void)
{
	int i = 0;
	...
	/* system_rev 00 / system_rev 01 / 02 = EVT 0 EMUL Board : nothing changed*/
		break;
	default:
        /* mega2elte h/w revision start from rev 1 */
		mega2elte_sleep_gpio_tables[i].table = sleep_gpio_table_default;
		mega2elte_sleep_gpio_tables[i].arr_size =
	...
	nr_mega2elte_sleep_gpio_table = i;
