...
static struct sleep_gpio_tables m2a3g_sleep_gpio_tables[MAX_BOARD_REV];
static int nr_m2a3g_sleep_gpio_table;
...
static void config_sleep_gpio_tables(void)
{
	...
	for (i = nr_m2a3g_sleep_gpio_table - 1; i >= 0; i--)
		config_sleep_gpio(m2a3g_sleep_gpio_tables[i].table,
				m2a3g_sleep_gpio_tables[i].arr_size);
}

void __init board_m2a3g_gpio_init(void)
{
	int i = 0;
	...
	/* system_rev 00 / system_rev 01 / 02 = EVT 0 EMUL Board : nothing changed*/
		break;
	default:
        /* m2a3g h/w revision start from rev 1 */
		m2a3g_sleep_gpio_tables[i].table = sleep_gpio_table_default;
		m2a3g_sleep_gpio_tables[i].arr_size =
