...
#else
static struct regulator_consumer_supply s2m_buck8_consumer =
	REGULATOR_SUPPLY("vdd_buck8", NULL);

static struct regulator_consumer_supply s2m_buck9_consumer =
	REGULATOR_SUPPLY("main_cam_core_1v2", NULL);
#endif
...
static struct regulator_init_data s2m_buck9_data = {
	.constraints	= {
		.name		= "PVDD_BUCK9",
		.min_uV		= 2000000,
		.max_uV		= 2000000,
	...
	.num_consumer_supplies	= 1,
	.consumer_supplies	= &s2m_buck9_consumer,
};
#endif
...
static struct sec_regulator_data exynos_regulators[] = {
	...
	{S2MPA01_BUCK8, &s2m_buck8_data},
#if !defined(CONFIG_EXYNOS5260_XYREF_REV0)
	{S2MPA01_BUCK9, &s2m_buck9_data},
#endif
...
struct sec_opmode_data s2mpa01_opmode_data[S2MPA01_REG_MAX] = {
	...
	[S2MPA01_BUCK8] = {S2MPA01_BUCK8, SEC_OPMODE_STANDBY},
#if !defined(CONFIG_EXYNOS5260_XYREF_REV0)
	[S2MPA01_BUCK9] = {S2MPA01_BUCK9, SEC_OPMODE_STANDBY},
#endif
