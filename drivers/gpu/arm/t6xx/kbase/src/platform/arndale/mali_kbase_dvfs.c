...
#else
static int mali_gpu_vol = 1250000; // 1.25V @ 600 MHz
#endif
#endif
...
#ifdef MALI_DVFS_ASV_ENABLE
#if ((MALI_DVFS_STEP != 8) && (MALI_DVFS_STEP != 6))
#error DVFS_ASV support only 7 or 5 steps
#endif
#if (MALI_DVFS_STEP == 8)
static const unsigned int mali_dvfs_asv_vol_tbl_special[MALI_DVFS_ASV_GROUP_SPECIAL_NUM][MALI_DVFS_STEP]=
  {
  	/*  100Mh   160Mh     266Mh   350Mh		400Mh   450Mh   533Mh   600Mh*/
  	{/*Group 1*/
  		912500, 925000, 1025000, 1075000, 1100000, 1150000, 1225000, 1275000,
  	},
  	{/*Group 2*/
  		900000, 900000, 1000000, 1037500, 1087500, 1125000, 1200000, 1250000,
  	},
  	{/*Group 3*/
  		912500, 925000, 1025000, 1037500, 1100000, 1150000, 1225000, 1275000,
  	},
  	{/*Group 4*/
  		900000, 900000, 1000000, 1025000, 1087500, 1125000, 1200000, 1250000,
  	},
  	{/*Group 5*/
  		912500, 925000, 1000000, 1000000, 1125000, 1150000, 1250000, 1300000,
  	},
  	{/*Group 6*/
  		900000, 912500, 987500, 987500, 1112500, 1150000, 1237500, 1250000,
  	},
  	{/*Group 7*/
  		900000, 900000, 975000, 987500, 1100000, 1137500, 1225000, 1275000,
  	},
  	{/*Group 8*/
  		900000, 900000, 975000, 987500, 1100000, 1137500, 1225000, 1275000,
  	},
  	{/*Group 9*/
  		887500, 900000, 962500, 975000, 1087500, 1125000, 1212500, 1237500,
  	},
  	{/*Group 10*/
  		887500, 900000, 962500, 962500, 1087500, 1125000, 1212500, 1237500,
  	},
};
...
static const unsigned int mali_dvfs_asv_vol_tbl[MALI_DVFS_ASV_GROUP_NUM][MALI_DVFS_STEP]=
{
  	/*  100Mh	160Mh	   266Mh	350Mh, 	400Mh	450Mh	533Mh   600Mh*/
  	{/*Group 0*/
  		925000, 925000, 1025000, 1075000, 1125000, 1150000, 1200000, 1250000,
  	},
  	{/*Group 1*/
  		900000, 900000, 1000000, 1037500, 1087500, 1137500, 1187500, 1225000,
  	},
  	{/*Group 2*/
  		900000, 900000, 950000, 1037500, 1075000, 1125000, 1187500, 1225000,
  	},
  	{/*Group 3*/
  		900000, 900000, 950000, 1037500, 1075000, 1125000, 1187500, 1225000,
  	},
  	{/*Group 4*/
  		900000, 900000, 937500, 1025000, 1075000, 1112500, 1175000, 1225000,
  	},
  	{/*Group 5*/
  		900000, 900000, 937500, 1000000, 1050000, 1100000, 1150000, 1175000,
  	},
  	{/*Group 6*/
  		900000, 900000, 925000, 987500, 1037500, 1087500, 1137500, 1187500,
  	},
  	{/*Group 7*/
  		900000, 900000, 912500, 987500, 1025000, 1075000, 1125000, 1187500,
  	},
  	{/*Group 8*/
  		900000, 900000, 912500, 987500, 1012500, 1075000, 1125000, 1187500,
  	},
  	{/*Group 9*/
  		900000, 900000, 900000, 975000, 1012500, 1050000, 1125000, 1187500,
  	},
  	{/*Group 10*/
  		875000, 900000, 900000, 962500, 1000000, 1050000, 1112500, 1187500,
  	},
  	{/*Group 11*/
  		875000, 900000, 900000, 962500, 1000000, 1050000, 1112500, 1187500,
  	},
