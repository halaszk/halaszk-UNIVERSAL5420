...
#else
#define MALI_T6XX_DEFAULT_CLOCK 600000000
#endif
...
static ssize_t show_clock(struct device *dev, struct device_attribute *attr, char *buf)
{
  ...
  #else
  	ret   += snprintf(buf + ret, PAGE_SIZE-ret, "\nPossible settings : 600, 533, 450, 400, 350, 266, 160, 100Mhz");
  #endif /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
...
static ssize_t show_upper_lock_dvfs(struct device *dev, struct device_attribute *attr, char *buf)
{
  	...
  	ret   += snprintf(buf + ret, PAGE_SIZE-ret, "\nPossible settings : 533, 450, 400, 266, 160, 100, If you want to unlock : 600 or off");
#endif /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
...
#else /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
		dev_err(dev, "Possible settings : 533, 450, 400, 266, 160, 100, If you want to unlock : 600 or off\n");
#endif /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
		return -ENOENT;
	}
#else /* CONFIG_MALI_T6XX_DVFS */
...
#else /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
  	ret   += snprintf(buf + ret, PAGE_SIZE-ret, "\nPossible settings : 600, 533, 450, 400, 266, 160, If you want to unlock : 100 or off");
#endif /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
...
#else /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
  		dev_err(dev, "Possible settings : 600, 533, 450, 400, 266, 160, If you want to unlock : 100 or off\n");
#endif /* CONFIG_MALI_T6XX_DVFS_LIMIT_450 */
  		return -ENOENT;
  	}
#else  /* CONFIG_MALI_T6XX_DVFS */
