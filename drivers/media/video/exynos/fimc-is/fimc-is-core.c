...
#endif
		fimc_is_sec_fw_sel(is_dev, sysfs_core->sensor->pdata, fw_name, setf_name, 1);
#if defined(CONFIG_PM_RUNTIME)
		...
		struct device_attribute *attr, char *buf)
{
	...
	char type_imx135[] = "SONY_IMX135_FIMC_IS";
	char type_imx134[] = "SONY_IMX134_FIMC_IS";
	char type_3l2[] = "SLSI_3L2_FIMC_IS";
	char type_imx175[] = "SONY_IMX175_FIMC_IS";
