...
#define GPIO_MDM2AP_HSIC_READY		EXYNOS5260_GPX3(6)
#define GPIO_AP2MDM_STATUS		EXYNOS5260_GPB2(3)
#define GPIO_MDM2AP_HSIC_PWR_ACTIVE	EXYNOS5260_GPX0(6)	/* AP2MDM_IPC2 */
//#define GPIO_WCN_PRIORITY		EXYNOS5260_GPF2(3)
#define GPIO_AP2MDM_ERR_FATAL		EXYNOS5260_GPE0(6)
#define GPIO_AP2MDM_PON_RESET_N		EXYNOS5260_GPD2(4)
#define GPIO_AP2MDM_WAKEUP		EXYNOS5260_GPE1(0)
#define GPIO_AP2MDM_SOFT_RESET		EXYNOS5260_GPM3(3)
#define GPIO_MDM2AP_STATUS		EXYNOS5260_GPX2(6)
#define GPIO_MDM2AP_HSIC_RESUME_REQ	EXYNOS5260_GPX3(5)	/* AP2MDM_IPC3 */
//#define GPIO_AP2MDM_VDDMIN		EXYNOS5260_GPX1(0)
//#define GPIO_MDM2AP_VDDMIN		EXYNOS5260_GPX1(1)
#define GPIO_MDM2AP_ERR_FATAL		EXYNOS5260_GPX1(2)
#define GPIO_AP2MDM_HSIC_PORT_ACTIVE	EXYNOS5260_GPE1(1)	/* AP2MDM_IPC1 */
#define GPIO_AP2MDM_PMIC_RESET_N	EXYNOS5260_GPD2(3)
