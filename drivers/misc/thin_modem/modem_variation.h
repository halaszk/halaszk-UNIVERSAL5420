...
DECLARE_MODEM_INIT(shannon);
#else
DECLARE_MODEM_INIT_DUMMY(shannon)
#endif

#ifdef CONFIG_LTE_MODEM_M74XX
DECLARE_MODEM_INIT(m74xx);
#else
DECLARE_MODEM_INIT_DUMMY(m74xx)
#endif
...
static modem_init_call modem_init_func[] = {
	...
	MODEM_INIT_CALL(shannon),
	MODEM_INIT_CALL(m74xx),
