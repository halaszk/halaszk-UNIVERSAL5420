...
#define FEATURE_SS_FACTORY
#define FEATURE_SS_MHL_RCP_SUPPORT
#define SFEATURE_MHL_TEST_CB
#define FEATURE_SS_MHL_TEST_APP_SUPPORT
...
/* delay in spec */
#define TSRC_VBUS_CBUS_STABLE	300 /*100~1000*/
#define TSRC_VBUS_OUT_TO_STABLE	300 /*100~1000*/
...
#define DEVCAP_VAL_DEV_CAT         (MHL_DEV_POW_SUPPLY | MHL_DEV_CAT_SOURCE)
#define DEVCAP_VAL_ADOPTER_ID_H    (uint8_t)(ADOPTER_ID >> 8)
#define DEVCAP_VAL_ADOPTER_ID_L    (uint8_t)(ADOPTER_ID & 0xFF)
...
struct mhl_tx {
	...
	struct work_struct	mhl_rsen_work;
	bool			rsen_ready;
	struct timer_list	rsen_timer;
